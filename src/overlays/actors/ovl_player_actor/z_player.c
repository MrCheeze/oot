...
void func_80848F9C(Player* this, GlobalContext* globalCtx, Input* arg2);
...
void func_808337D4(GlobalContext* globalCtx, Player* this) {
    ...
    sp44 = Actor_SpawnAttached(&globalCtx->actorCtx, &this->actor, globalCtx, sp48->actorId, this->actor.posRot.pos.x,
...
void func_80833910(GlobalContext* globalCtx, Player* this) {
    ...
    this->heldActor =
        Actor_SpawnAttached(&globalCtx->actorCtx, &this->actor, globalCtx, ACTOR_ARMS_HOOK, this->actor.posRot.pos.x,
                            this->actor.posRot.pos.y, this->actor.posRot.pos.z, 0, this->actor.shape.rot.y, 0, 0);
}
...
s32 func_80833C98(s32 item1, s32 item2) {
    if ((item1 < 0xFE) && (func_80833724(item1) == item2)) {
        return 1;
    } else {
        return 0;
    }
...
void func_80833DF8(Player* this, GlobalContext* globalCtx) {
    ...
    if (this->currentMask != 0) {
        maskItem = this->currentMask + 0x39;
        ...
        if (this->stickFlameTimer >= 0) {
            ...
            if (!func_8008F104(this) && (func_80834380(globalCtx, this, &sp54, &sp50) > 0)) {
                ...
                if (this->stickFlameTimer >= 0) {
                    ...
                    this->heldActor = Actor_SpawnAttached(
                        &globalCtx->actorCtx, &this->actor, globalCtx, ACTOR_EN_ARROW, this->actor.posRot.pos.x,
                        this->actor.posRot.pos.y, this->actor.posRot.pos.z, 0, this->actor.shape.rot.y, 0, sp50);
                }
            }
        }
        return 1;
...
s32 func_80834FBC(Player* this) {
    if (this->actor.attachedB != NULL) {
        if (this->heldActor == NULL) {
            this->heldActor = this->actor.attachedB;
...
s32 func_80836670(Player* this, GlobalContext* globalCtx) {
    if (!(this->stateFlags1 & 0x800000) && (this->actor.attachedA != NULL) && func_8008F104(this)) {
...
s32 func_80839800(Player* this, GlobalContext* globalCtx) {
    ...
    if ((this->unk_42C != 0) &&
        ...
        if (CHECK_PAD(D_80858AB4->press, A_BUTTON) || (func_8084F9A0 == this->actionFunc)) {
            ...
            if (((attached = door->actor.attachedB) != NULL) || ((attached = door->actor.attachedA) != NULL)) {
...
void func_8083A0F4(GlobalContext* globalCtx, Player* this) {
    if (func_8083A0D4(this)) {
        ...
        if (interactActorId == ACTOR_BG_TOKI_SWD) {
            this->interactRangeActor->attachedA = &this->actor;
...
void func_8083BCD0(Player* this, GlobalContext* globalCtx, s32 arg2) {
    ...
    func_80838940(this, D_80853D4C[arg2][0], temp, globalCtx, NA_SE_VO_LI_SWORD_N);
        ...
        if (iREG(67) || (this->getItemId > 0)) {
            ...
            if (this->getItemId < 0x7E) {
                ...
                if ((interactedActor != &this->actor) && !iREG(67)) {
                    interactedActor->attachedA = &this->actor;
                }
...
void func_80846050(Player* this, GlobalContext* globalCtx) {
    ...
    if (func_800A4530(&this->skelAnime, 4.0f)) {
        ...
        if (!func_80835644(globalCtx, this, interactRangeActor)) {
            ...
            this->actor.attachedB = interactRangeActor;
            interactRangeActor->attachedA = &this->actor;
...
void func_80846120(Player* this, GlobalContext* globalCtx) {
    ...
    if (func_800A4530(&this->skelAnime, 41.0f)) {
        ...
        this->actor.attachedB = &heavyBlock->dyna.actor;
        heavyBlock->dyna.actor.attachedA = &this->actor;
...
void Player_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    age = gSaveContext.linkAge;
    func_80846AAC(this, globalCtx, D_80125B70[age]);
...
void func_808486A8(GlobalContext* globalCtx, Player* this) {
    ...
    if (this->actor.type == ACTORTYPE_PLAYER) {
        ...
        if (this->action != 0) {
            ...
            if ((this->actor.attachedA != NULL) && (this->unk_692 & 0x80)) {
                sp18 = 9;
                Camera_SetParam(Gameplay_GetCamera(globalCtx, 0), 8, this->actor.attachedA);
...
void Player_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    Graph_OpenDisps(dispRefs, globalCtx->state.gfxCtx, "../z_player.c", 19346);
    ...
    if (!(this->stateFlags2 & 0x20000000)) {
        ...
        if (this->invincibilityTimer > 0) {
            ...
            gfxCtx->polyOpa.p = Gfx_SetFog2(gfxCtx->polyOpa.p, 0xFF, 0x00, 0x00, 0x00, 0,
        ...
        if (this->unk_6AD != 0) {
            Vec3f sp7C;
            func_800A6EF4(&globalCtx->mf_11D60, &this->actor.posRot2.pos, &sp7C);
            if (sp7C.z < -4.0f) {
                sp90 = func_800902F0;
            }
        ...
        gSPClearGeometryMode(gfxCtx->polyOpa.p++, G_CULL_BOTH);
        gSPClearGeometryMode(gfxCtx->polyXlu.p++, G_CULL_BOTH);
        ...
        if (this->stateFlags2 & 0x4000) {
            ...
            gSPMatrix(gfxCtx->polyXlu.p++, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_player.c", 19459),
                      G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
            gDPSetEnvColor(gfxCtx->polyXlu.p++, 0x00, 0x32, 0x64, 0xFF);
            gSPDisplayList(gfxCtx->polyXlu.p++, D_04033EE0);
        }
    ...
    Graph_CloseDisps(dispRefs, globalCtx->state.gfxCtx, "../z_player.c", 19473);
}
        ...
        if ((globalCtx->csCtx.state == 0) && (globalCtx->transitionMode == 0)) {
            ...
            if (((rideActor->unk_1F0 & 0x40) ? true : false) ||
                ...
                if (((rideActor->unk_1F0 & 0x40) ? true : false) ||
                    ...
                    rideActor->actor.attachedB = NULL;
...
void func_8084CC98(Player* this, GlobalContext* globalCtx) {
    ...
    if ((this->action != 0) || func_8083224C(globalCtx) ||
        (((rideActor->actor.speedXZ != 0.0f) || !func_8083B644(this, globalCtx)) && !func_8083C1DC(this, globalCtx))) {
        if (D_808535E0 == 0) {
            if (this->unk_84F != 0) {
                if (func_800A3BC0(globalCtx, &this->skelAnime2)) {
...
void func_808526EC(GlobalContext* globalCtx, Player* this, CsCmdActorAction* arg2) {
    ...
    func_800A6EF4(&this->mf_A20, &sp34, &sp40);
