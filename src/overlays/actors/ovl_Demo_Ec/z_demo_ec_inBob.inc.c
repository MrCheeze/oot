void Demo_Ec_main_init_Bob(DemoEc* this, PlayState* play) {
    Demo_Ec_Change_ShapeBank(this, play);
    Demo_Ec_Setup_Mdl(this, play, &gHylianWoman2Skel);
...
void Demo_Ec_main_Bob_Wait(DemoEc* this, PlayState* play) {
...
void Demo_Ec_draw_normal_Bob(DemoEc* this, PlayState* play) {
    static void* Demo_Ec_inBob_eye[] = {
        gHylianWoman2EyeOpenTex,
        gHylianWoman2EyeHalfTex,
        gHylianWoman2EyeClosedTex,
    };
    s32 eyeTexIndex = this->eyeTexIndex;
    void* eyeTexture = Demo_Ec_inBob_eye[eyeTexIndex];
