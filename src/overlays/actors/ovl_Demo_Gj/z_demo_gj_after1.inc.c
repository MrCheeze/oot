// Inits the three cylinders with `Demo_Gj_after1_OcInfoData_forStand`
void Demo_Gj_Actor_init_after1(DemoGj* this, PlayState* play) {
    Demo_Gj_Actor_init_battle_common(this, play, 15, 0, NULL);
    Demo_Gj_ct_forCorect(this, play, &this->cylinders[0], &Demo_Gj_after1_OcInfoData_forStand);
    Demo_Gj_ct_forCorect(this, play, &this->cylinders[1], &Demo_Gj_after1_OcInfoData_forStand);
    Demo_Gj_ct_forCorect(this, play, &this->cylinders[2], &Demo_Gj_after1_OcInfoData_forStand);
}
 ...
 */
void Demo_Gj_after1_SetPos_forCorect(DemoGj* this, PlayState* play) {
...
void Demo_Gj_after1_SetAC(DemoGj* this, PlayState* play) {
    s32 pad[2];
...
void Demo_Gj_after1_Set_Piece(DemoGj* this, PlayState* play, Vec3f* direction) {
    Vec3f pos;
...
void Demo_Gj_Check_WaitToBattle_after1(DemoGj* this, PlayState* play) {
    if (Demo_Gj_Check_MoveToStop_common(this, play)) {
        Vec3f* scale = &this->dyna.actor.scale;

        Demo_Gj_Actor_init_BGdata_common(this, play, &gGanonsCastleRubble2Col);
        this->updateMode = 18;
        this->drawConfig = 16;
        scale->x *= 0.8f;
        scale->y *= 0.8f;
...
s32 Demo_Gj_after1_Check_Break_forStand(DemoGj* this, PlayState* play) {
 ...
 * Used by DEMOGJ_TYPE_DESTRUCTABLE_RUBBLE_1
 */
void Demo_Gj_Check_BattleToBranch_after1(DemoGj* this, PlayState* play) {
    Actor* thisx = &this->dyna.actor;

    if (Demo_Gj_Check_demo_info(this, 4)) {
        Actor_delete(thisx);
    } else if (Demo_Gj_after1_Check_Break_forStand(this, play)) {
        Vec3f vec1 = { 0.0f, 0.0f, 0.0f };

        Birth_Item_In_Demo_Gj(this, play);
        Demo_Gj_after1_Set_Piece(this, play, &vec1);
        ...
        Birth_Item_In_Demo_Gj(this, play);
        Demo_Gj_after1_Set_Piece(this, play, &vec2);

        Actor_delete(thisx);
    }

    Demo_Gj_after1_SetPos_forCorect(this, play);
    Demo_Gj_after1_SetAC(this, play);
}

// func_8097B340
void Demo_Gj_main_Wait_after1(DemoGj* this, PlayState* play) {
    Demo_Gj_Search_Boss_Ganon(this, play);
    Demo_Gj_Check_WaitToBattle_after1(this, play);
}

// func_8097B370
void Demo_Gj_main_Battle_after1(DemoGj* this, PlayState* play) {
    Demo_Gj_Check_BattleToBranch_after1(this, play);
#if DEBUG_FEATURES
    DemoGj_DoNothing1(this, play);
#endif
}

void Demo_Gj_draw_normal_after1(DemoGj* this, PlayState* play) {
